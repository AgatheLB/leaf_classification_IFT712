...
class RF():
    ...
    def __init__(self, train, labels, test, test_ids, classes):
        ...
        """
        self._name = RandomForestClassifier.__name__
        self._train = train
        self._test = test
        self._labels = labels
        ...
        self._classifier = RandomForestClassifier(n_jobs=-1, random_state=42)
    ...
    def hyperparam_search(self):
        ...
        """
        param_grid = {'n_estimators': [350, 400, 450], "max_depth": [20, 25, 30, 35]}
        ...
        print(f'Meilleurs paramètres trouvés pour {self._name} sont {self._best_pair} pour une justesse de '
              f'{grid.best_score_}')
    ...
    def train(self):
        ...
        print(f'{self._name} trained avec les paramètres {self._best_pair}')
